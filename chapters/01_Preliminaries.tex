...
As mentioned in introduction \TODO{fix numbering or use just \\ref here}\autoref{chap:introduction}, the \lpa{} project is a web platform that aims to provide a comfortable and intuitive user experience to generate interactive Linked Data based visualizations by some \TODO{some?} \textit{domain experts}. \TODO{I would repeat here that it was developed as a sw project} The visualization is referred to as an application after being published, and it can then be embedded in an online article or on another web page or perhaps accessed as a standalone page. 
...
This general user story represents the most generic interaction flow with \lpa{} platform from the standpoint of its target users. The consecutive sections will dive into more technical details, components, and functional aspects of this platform. 
