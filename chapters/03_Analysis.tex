...
\begin{itemize}
    \TODO{I think Store app should not include Publish app. Publish app should extend store app.}
...
\TODO{again, the includes seem wrong. When UC1 includes UC2, it means that UC2 is necessary/mandatory for UC1. In this case it would mean that whenever I "manage" storage, I need to delete data and edit data, etc. I get what you try to say, but "includes" means something else. I would consider using "inheritance" for this }
