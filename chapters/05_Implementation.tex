...
The initial configuration or startup guide to \TODO{oo} \textit{Ontology} consist of the following steps: 
\begin{enumerate}
...
\begin{itemize}
    ...
    \item \textit{Redux} represents a container that stores various states of the web application per individual webpage. \TODO{this is duplicate of redux description earlier - it should link there}
        \begin{itemize}
